...
export function CodeBlock({
  ...
  if (!inline) {
    return (
      <div className="not-prose flex flex-col my-2 w-full">
        <pre
          {...props}
          className={` w-full  dark:bg-zinc-900 p-4 pt-2 border border-zinc-200 dark:border-zinc-700 rounded-xl dark:text-zinc-50 text-zinc-900`}
        >
